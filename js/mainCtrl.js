angular.module('itunes').controller('mainCtrl', function($scope, itunesService){
  ...
  //the 'data' property. The value is 'songData'. That means ng-grid is looking for
  //songData on $scope and is putting whatever songData is into the grid.
  ...
  */
  ...
  // (or more specifically on the scope as songData). Once you do this ($scope.songData = myFinalArray) then ng-grid will see that and populate the page.
